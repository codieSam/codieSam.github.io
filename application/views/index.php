                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 overflow-hidden ms-4">
                        ...
                        <p class="text-muted mb-0 text-truncate">
                          <span
                            class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"
                            ><i class="mdi mdi-arrow-top-right"></i> 2.8%
                            Increase</span
                          >
                          vs last month
                        </p>
                      ...
                      <div class="flex-shrink-0 align-self-start">
                        <div class="dropdown">
                          ...
                          >
                            <i
                              class="ri-more-2-fill text-muted font-size-16"
                            ></i>
                          </a>
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 overflow-hidden ms-4">
                        ...
                        <p class="text-muted mb-0 text-truncate">
                          <span
                            class="badge bg-subtle-danger text-danger font-size-12 fw-normal me-1"
                            ><i class="mdi mdi-arrow-bottom-left"></i> 7.8%
                            Loss</span
                          >
                          vs last month
                        </p>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 overflow-hidden ms-4">
                        ...
                        <p class="text-muted mb-0 text-truncate">
                          <span
                            class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"
                            ><i class="mdi mdi-arrow-top-right"></i> 4.6%
                            Growth</span
                          >
                          vs last month
                        </p>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 overflow-hidden ms-4">
                        ...
                        <p class="text-muted mb-0 text-truncate">
                          <span
                            class="badge bg-subtle-success text-success font-size-12 fw-normal me-1"
                            ><i class="mdi mdi-arrow-top-right"></i> 23%
                            Increase</span
                          >
                          vs last month
                        </p>
                          ...
                          >
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <span
                                    class="badge bg-subtle-primary text-primary font-size-11 ms-1"
                              ...
                              <tr>
                                ...
                                <td>
                                  <span
                                    class="badge bg-subtle-danger text-danger font-size-11 ms-1"
                      ...
                      >
                        <tbody>
                          <tr>
                            ...
                            <td class="text-muted">
                              <i
                                class="mdi mdi-trending-up text-success font-size-18 align-middle me-1"
                              ></i
                              >$250.00
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td class="text-muted">
                              <i
                                class="mdi mdi-trending-down text-danger font-size-18 align-middle me-1"
                              ></i
                              >$110.00
                            </td>
                            <td>
                      ...
                      <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <span
                                class="badge rounded badge-soft-danger font-size-12"
                                >Cancel</span
                              >
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <span
                                class="badge rounded badge-soft-warning font-size-12"
                                >Shipping</span
                              >
                            </td>
                            <td>
