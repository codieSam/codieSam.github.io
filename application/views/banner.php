							...
							<div class="card">
								<div class="card-header border-0 align-items-center d-flex pb-0">
									...
									<div class="text-center mt-4">
										<a href="javascript: void(0);" class="btn btn-primary waves-effect waves-light btn-sm">View all
											banners <i class="mdi mdi-arrow-right ms-1"></i></a>
									</div>
								</div>
								<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-floating mb-3">
													<input type="file" class="form-control" id="floatingFirstnameInput"
														placeholder="Enter pin code" name="bann_image">
